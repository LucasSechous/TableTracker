# Contrato de la vista en vivo de detecciones (T26-150): POST/GET
# /camaras/{id}/deteccion-actual en app/routers/camaras.py.
#
# Es una copia deliberada de vision-module/schemas/detection_output.py (Sprint 5,
# DetectionFrameResult/Detection/DetectionBox), campo por campo, no un import
# cruzado: backend y vision-module son procesos independientes con su propio
# entorno (ver docs/vision-loop.md, "corre fuera del backend"), sin un paquete
# instalado en común del que importar. Si el contrato cambia, hay que replicar
# el cambio acá también.
