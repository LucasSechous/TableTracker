...
from app.routers.auth import get_usuario_actual, get_admin_actual
...
@router.patch("", response_model=ConfiguracionResponse, dependencies=[Depends(get_admin_actual)])
